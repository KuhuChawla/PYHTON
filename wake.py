...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', type=int, default=1, help="This defines verbosity level. This is for to see how many times the mouse has moved. Default is 1 and maximum is 2")
